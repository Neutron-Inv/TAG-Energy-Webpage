...
<!-- /page_banner start-->
<div class="carousel-item active contact-bg" style="background-image: url({{load_asset('images/contact-us-4.jpg')}}); background-size:cover; height:300px; width:100%;">
      ...
      <div class="col-md-4">
        ...
        <div class="get_title1">
          ...
          <div class="call_box"> 
            ...
            <a href="tel:+44 7947 674380" >+44 7947 674380</a></p>
          </div>
        ...
        <div class="get_title1">
          ...
          <div class="call_box"> 
            <i class="fa fa-phone" aria-hidden="true"></i>
            <!-- <h4>Call us</h4> -->
            <p><a href="#">+234 906 243 5416, +234 708 790 5939</a></p>
          </div>
