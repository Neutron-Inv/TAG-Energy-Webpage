      ...
      <div class="col-lg-12 col-sm-12 col-md-12">
        <div class="row">   
          ...
          <div class="col-md-4">
            <div class="news_box blog_page">
              <div class="news_img"> 
                <img class="img-fluid" src="{{load_asset('images/product/bosch-1.jpg')}}" alt="insulation image" />
              </div>
              <div class="news_detail">
                <h3>Bosch Rexroth</h3>
                <p>As a Bosch Rexroth distributor and local rep, we are well-positioned to provide access to high-quality and .... {{--manufacturer to distribute and install durable and sustainable stone wool insulation products in the Nigerian market…--}}</p>                  
                <a href="{{route('get-bosch-products')}}" style="color: #fc786a">Read More <i class="fa fa-arrow-right" aria-hidden="true"></i></a>
              </div>
            </div>
          </div>  
