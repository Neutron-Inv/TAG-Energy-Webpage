                ...
                <div class="col-lg-6 col-md-12 mb-5">
                    <div class="project-card"
                        ...
                        <div style="padding: 20px;">
                            <div class="client-logo mb-3" style="text-align: center;">
                            ...
                            <p style="color: #666; margin-bottom: 15px;">Comprehensive overhaul and refurbishment of the
                                ...
                                efficiency.</p>
                            <div class="project-details" style="border-top: 1px solid #eee; padding-top: 15px;">
                                <p style="margin-bottom: 5px;"><strong>Client:</strong> Nigeria Liquefied Natural Gas
                                    Limited (NLNG)</p>
                                <p style="margin-bottom: 5px;"><strong>Location:</strong> Bonny Island, Rivers State</p>
                    ...
                    <div class="project-card"
                        ...
                        <div style="padding: 20px;">
                            ...
                            <div class="project-details" style="border-top: 1px solid #eee; padding-top: 15px;">
                                ...
                                <p style="margin-bottom: 5px;"><strong>Location:</strong> Opic Industrial Estate, Ogun</p>
                    ...
                    <div class="project-card"
                        ...
                        <div style="padding: 20px;">
                            ...
                            <div class="project-details" style="border-top: 1px solid #eee; padding-top: 15px;">
                                ...
                                <p style="margin-bottom: 5px;"><strong>Location:</strong> Victoria Island, Lagos</p>
                    ...
                    <div class="project-card"
                        ...
                        <div style="padding: 20px;">
                            ...
                            <div class="project-details" style="border-top: 1px solid #eee; padding-top: 15px;">
                                ...
                                <p style="margin-bottom: 5px;"><strong>Location:</strong> Victoria Island, Lagos</p>
                                <p style="margin-bottom: 5px;"><strong>Date:</strong> January 2019 - December 2019</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="project-card"
                        ...
                        <div style="padding: 20px;">
                            ...
                            <h3 style="font-size: 1.2rem; color: #333; margin-bottom: 15px;">Assurance and Spare Supply for
                                Doedijns Actuators & Hydraulic ROVs Actuators & Hydraulic ROVs
                            </h3>
