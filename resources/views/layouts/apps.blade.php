...
<head>
    ...
    <title>HOME</title>
    <link href="{{ load_asset('images/favicon/logo-180x180.png') }}" rel="shortcut icon">
                        ...
                        <div class="dropdown">
                            <a
                                ...
                                <img
                                    ...
                                    src="{{ asset('design/components/core/img/avatars/avatar-2.png')}}"
                                    alt="Name"
                                />
                            </a>
