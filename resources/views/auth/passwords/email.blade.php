...
<div class="air__auth">
    <div class="pt-4 pb-4 d-flex align-items-end mt-auto">
        <img src="{{load_asset('images/logo/cropped.png')}}" style="width:50px; height:40px" alt="IGR Logo" />
    ...
    <div class="text-center font-size-18 pt-3 mb-auto">
        ...
        <a href="{{ route('login') }}" class="font-weight-bold text-blue text-underlined"><u>Sign in</u></a>
    </div>
