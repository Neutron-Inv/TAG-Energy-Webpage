        ...
        <div class="row">
          ...
          <p>TAG Energy is an integrated service company offering a comprehensive range of oilfield products and support services in the Nigerian Oil and Gas Industry.</p>
                ...
                <div class="footer_title">
                    <h2><img src="{{ load_asset('images/logo/cropped_white.png') }}" alt="Solace Runnels"></h2><br>
                </div>
                <div class="add_box">
                    <p>TAG Energy is an integrated service company offering a comprehensive range of oilfield products
                        and support services in the Nigerian Oil and Gas Industry.</p>
                </div>
                        ...
                        <div class="input-group">
                            ...
                            <span class="input-group-btn">
                                <button class="btn btn-success btn-lg" type="submit"
                                    style="background: #b8d411; border-color: #fff"><i class="fa fa-paper-plane"
