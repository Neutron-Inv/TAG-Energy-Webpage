<nav class="main-nav">
  ...
  <h2 class="nav-brand"><a href="{{route('tagenergy')}}"><img class="img-fluid header_logo" src="{{load_asset('images/logo/cropped.png')}}"><img class="img-fluid logo_stricky" src="{{load_asset('images/logo/cropped.png')}}"></a></h2>
