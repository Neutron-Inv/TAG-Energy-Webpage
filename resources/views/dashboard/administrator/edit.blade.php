<?php $title =' Edit an Administrator' ?>
@extends('layouts.apps')
    ...
    <div class="col-lg-12 mb12">
		...
		<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-bold" style="color:blue">
            ...
            <li class="nav-item">
				<a class="nav-link active" href="{{route('administrator.edit', $details->email)}}" data-toggle="false">
					<i class="icmn-pencil"></i>
					Edit an Administrator
				</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="{{route('administrator.index')}}" data-toggle="false">
	...
	<div class="air__layout__content">
		<div class="air__utils__content">
			<h6 class="mb-4">
				<strong>Please fill The below form to edit an administrator</strong>
			</h6>
			<div class="card">
				...
				<div class="card-body">
					...
					<form action="{{ route('administrator.update',$details->email) }}" id="form-validation" name="form-validation" method="POST" class="pt-3 width-710 mx-auto">
                        {{ csrf_field() }}
                        <div class="form-row">
