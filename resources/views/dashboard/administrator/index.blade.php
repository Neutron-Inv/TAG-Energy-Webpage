...
@extends('layouts.apps')
    ...
    <div class="col-lg-12 mb12">
		...
		<ul class="nav nav-tabs nav-tabs-line nav-tabs-line-bold" style="color:blue">
			...
			<li class="nav-item">
				<a class="nav-link active" href="{{route('administrator.index')}}" data-toggle="false">
		...
		<div class="air__utils__content">
			...
			<div class="card">
				...
				<div class="card-body">
                    ...
                    <form action="{{ route('administrator.store') }}" id="form-validation" name="form-validation" method="POST" class="pt-3 width-710 mx-auto">
                        {{ csrf_field() }}
                        <div class="form-row">
                        ...
                        <div class="form-actions" align="right">
                            <button type="submit" class="btn btn-primary mr-2 px-5">Create new Administrator</button>
            ...
            @if(count($user) > 0)
                <div class="card" >
                    <div class="card-body" style="backgroud-color:gray">
                        ...
                        <h6 class="mb-4">
                            <strong>List of All Administrators</strong>
                        </h6>
                                    ...
                                    @foreach($user as $users)
                                        <tr><small>
                                            <td> {{ $number}}
                                                ...
                                                <a href="{{ route('administrator.edit',$users->email)}}">
                                                    <i class="fe fe-edit mr-1" aria-hidden="true" style="color:blue"></i>
                                                </a>
                                               
                                                <a href="{{ route('administrator.delete',$users->email)}}">
